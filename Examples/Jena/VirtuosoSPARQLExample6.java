...
public class VirtuosoSPARQLExample6
{
	...
	VirtGraph graph = new VirtGraph ("Example6", "jdbc:virtuoso://localhost:1111", "dba", "yourPass");
	...
	org.apache.jena.util.iterator.ExtendedIterator iter = graph.find(Node.ANY, Node.ANY, Node.ANY);
