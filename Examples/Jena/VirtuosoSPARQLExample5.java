...
public class VirtuosoSPARQLExample5
{
	...
	VirtGraph graph = new VirtGraph ("Example5", "jdbc:virtuoso://localhost:1111", "dba", "yourPass");
	...
	org.apache.jena.util.iterator.ExtendedIterator<org.apache.jena.graph.Triple> iter = graph.find(foo1, Node.ANY, Node.ANY);
