...
/*			STEP 1			*/
		VirtGraph set = new VirtGraph ("jdbc:virtuoso://localhost:1111", "dba", "yourPass");
...
System.out.println("\nexecute: INSERT INTO GRAPH <http://test1> { <aa> <bb> 'cc' . <aa1> <bb1> 'Prueba123'. }");
                str = "INSERT INTO GRAPH <http://test1> { <aa> <bb> 'cc' . <aa1> <bb1> 'Prueba123'. }";
...
System.out.println("\nexecute: SELECT * FROM <http://test2> WHERE { ?s ?p ?o }");
